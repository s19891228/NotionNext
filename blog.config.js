...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '海王-星', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '致力当海王的小星，欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.hwxsaojieonline.top
', // 网站地址
